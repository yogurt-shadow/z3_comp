...
#define NLSAT_VB_LVL 10
    ...
    // wzh nlcac
    typedef ptr_vector<poly> poly_vector;
    // hzw
    ...
    public:
        ...
        // wzh
        bool is_equal_atom() const {return m_kind == EQ || m_kind == ROOT_EQ;}
        bool is_ineq_equal_atom() const {return m_kind == EQ;}
        bool is_root_equal_atom() const {return m_kind == ROOT_EQ;}
        // hzw
